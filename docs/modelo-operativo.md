...
> Registro de la primera versión. El [contexto vigente](contexto-vigente.md) y
> el [README del servicio](../apps/api/README.md) reemplazan las descripciones
> de fixtures, campos y pantallas de este documento. Se conservan las matrices
> históricas como referencia, sin presentar sus ejemplos como datos actuales.
