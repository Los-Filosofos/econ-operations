...
Reabrir esta decisión si se requiere SSR, funciones de servidor web, unificación del backend en TypeScript o despliegue exclusivo de todos los servicios dentro de Workers. Los pasos de ejecución vigentes están en [desarrollo](../desarrollo.md); la [guía histórica de Cloudflare](https://github.com/Los-Filosofos/econ-operations/blob/e851c7ec01890eda54d736d4d9eeaa161a8a8fce/docs/deploy-cloudflare.md) se conserva en Git.
